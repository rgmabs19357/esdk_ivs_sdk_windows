...
typedef enum enIvsError
{
    ...
    IVS_SMU_CREATE_CLUSTERING              = 119126004,    // 正在组建集群
    IVS_SMU_DISSOLVE_CLUSTERING            = 119126005,    // 正在解散集群
	...
	IVS_SCU_DEV_NOT_IN_WHITE_LIST          = 129108022,    // 设备不属于当前NVR，可能已移除
	...
	IVS_SCU_PRESET_IS_GUARD_POS            = 129117007,    // 预置位被设置成看守位，不能删除
	...
	*******************************************/ 
	...
	IVS_CMU_ADD_DEV_ERROR                  = 149113001,    // 添加设备失败
	IVS_CMU_ADD_DEVS_SOME_ERROR            = 149113002,    // 添加一些设备失败
	IVS_CMU_ADD_DEVS_ALL_ERROR             = 149113003,    // 添加所有设备失败	 
