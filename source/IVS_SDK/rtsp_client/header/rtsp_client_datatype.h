...
/// 定义模块名
#define RTSP_CLIENT_SERVICE_NAME  "IVS_rtsp"
/// 日志目录
#define RTSP_CLIENT_LOG_PATH      "../log/rtsp_log"
...
typedef enum _enRTSP_SESSION_STATUS
{
    ...
    RTSP_SESSION_STATUS_DELETE           // 删除状态
}RTSP_SESSION_STATUS;
...
// 异常回调函数 //__stdcall
typedef  void (RTSPAPI *fExceptionCallBack)(int handle,
...
// 媒体流回调//__stdcall
typedef  void (RTSPAPI *fDataCallBack)(int handle, 
                               char *pBuffer,
